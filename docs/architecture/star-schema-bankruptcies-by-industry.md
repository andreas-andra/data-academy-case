...
![Star Schema](../diagrams/bankruptcies_by_industry.svg)

Source: [`docs/diagrams/bankruptcies_by_industry.dbml`](../diagrams/bankruptcies_by_industry.dbml) — SVGs are auto-generated by CI on every DBML change.
