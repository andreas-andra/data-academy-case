...
![Star Schema](../diagrams/bankruptcy_risk_hotspots.svg)

Source: [`docs/diagrams/bankruptcy_risk_hotspots.dbml`](../diagrams/bankruptcy_risk_hotspots.dbml) — SVGs are auto-generated by CI on every DBML change.
