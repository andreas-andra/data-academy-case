...
![Star Schema](../diagrams/<name>.svg)

Source: [`docs/diagrams/<name>.dbml`](../diagrams/<name>.dbml) — SVGs are auto-generated by CI on every DBML change.
```
...
- ALWAYS generate an SVG after creating or modifying a DBML file by running:
  `npx -y @softwaretechnik/dbml-renderer -i docs/diagrams/<name>.dbml -o docs/diagrams/<name>.svg -f svg`
- ALWAYS embed the SVG in the star-schema doc: `![Star Schema](../diagrams/<name>.svg)`
